...
import { badgeUrlParse, BadgeType } from '@utils/index'
import { ReactComponent as DeflaultCompetitor } from '@/assets/svg/defaultIcon.svg'
...
const DefaultImg: React.FC<{ type: BadgeType }> = ({ type }) => {
  ...
  return isLoad
    ...
    : (isDefaultCate ? <img src={require('@/assets/img/defaultCategory.png')} alt='badge' /> : <DeflaultCompetitor />)
}
