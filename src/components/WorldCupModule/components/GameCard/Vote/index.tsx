...
import { worldCupBallName, StatesConst, RoundConf } from '../../../constants'

import { useGameContext } from '../store/GameContext'
import { useVoteUserContext } from '../../../store/VoteUserContext'
  ...
  return (
    <div className={styles.voteBtn}>
      <div
        ...
        className={cx(styles.left, { [styles.close]: parseData.leftClose })} >投票</div>
      <div
        onClick={voteHandler.bind(null, parseData.right)}
        className={cx(styles.right, { [styles.close]: parseData.rightClose })}>投票</div>
    </div>
  )
})
