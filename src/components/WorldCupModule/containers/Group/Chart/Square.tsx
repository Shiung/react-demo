...
import type { GameInfo } from '../../../types' // '@sport/components/WorldCupModule/types'
import { useParseScore } from '../../../components/GameCard/Content/hooks' //'@sport/components/WorldCupModule/components/GameCard/Content/hooks'
