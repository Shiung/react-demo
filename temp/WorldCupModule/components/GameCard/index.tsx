...
import { PageNameThird } from '@sport/components/WorldCupModule/constants'
import type {
  GameInfo
} from '@sport/components/WorldCupModule/types'
        ...
        {modal === 'champion' && ( /** 樹狀圖 淘汰賽 冠軍 */
          <>
            ...
            <div className={styles.footer}>
              <img src={require('@sport/components/WorldCupModule/image/champion.png').default} alt="footer" />
            </div>
          </>
        )}
